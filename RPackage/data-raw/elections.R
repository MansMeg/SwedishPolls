...
elect <- data.frame(rbind(c(0.2192, 0.0912, 0.0850, 0.0714, 0.3771, 0.0451, 0.0338, 0.0009, 0),
...
elec_date <- c(as.Date('1991-09-15'), as.Date('1994-09-18'), as.Date('1998-09-20'), as.Date('2002-09-15'), as.Date('2006-09-17'),as.Date('2010-09-19'),as.Date('2014-09-14'), as.Date('2018-09-09'))
publ_year <- c("1991-sep", "1994-sep", "1998-sep", "2002-sep", "2006-sep","2010-sep","2014-sep", "2018-sep")
eligible_votes <- c(5470761, 5555540, 5261122, 5303212, 5551278, 6028682, 6290016, 6532063)
