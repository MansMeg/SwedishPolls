...
elect <- data.frame(rbind(c(0.2364, 0.0590, 0.1548, 0.0187, 0.4561, 0.0556, 0.0165,     NA, 0),
...
elec_date <- c(as.Date('1982-09-19'), as.Date('1985-09-15'), as.Date('1988-09-18'), as.Date('1991-09-15'), as.Date('1994-09-18'), as.Date('1998-09-20'), as.Date('2002-09-15'), as.Date('2006-09-17'),as.Date('2010-09-19'),as.Date('2014-09-14'), as.Date('2018-09-09'))
publ_year <- c("1982-sep","1985-sep", "1988-sep", "1991-sep", "1994-sep", "1998-sep", "2002-sep", "2006-sep","2010-sep","2014-sep", "2018-sep")
eligible_votes <- c(5554602, 5567022, 5373719, 5470761, 5555540, 5261122, 5303212, 5551278, 6028682, 6290016, 6532063)
