...
elect <- data.frame(rbind(c(0.1559, 0.1106, 0.2408, 0.0136, 0.4275, 0.0475,      0,     NA, 0),
                          c(0.2034, 0.1059, 0.1807, 0.0139, 0.4324, 0.0561,      0,     NA, 0),
...
elec_date <- c(as.Date('1976-09-19'),as.Date('1979-09-16'), as.Date('1982-09-19'), as.Date('1985-09-15'), as.Date('1988-09-18'), as.Date('1991-09-15'), as.Date('1994-09-18'), as.Date('1998-09-20'), as.Date('2002-09-15'), as.Date('2006-09-17'),as.Date('2010-09-19'),as.Date('2014-09-14'), as.Date('2018-09-09'))
publ_year <- c("1976-sep", "1979-sep", "1982-sep","1985-sep", "1988-sep", "1991-sep", "1994-sep", "1998-sep", "2002-sep", "2006-sep","2010-sep","2014-sep", "2018-sep")
eligible_votes <- c(5437748, 5448638, 5554602, 5567022, 5373719, 5470761, 5555540, 5261122, 5303212, 5551278, 6028682, 6290016, 6532063)
