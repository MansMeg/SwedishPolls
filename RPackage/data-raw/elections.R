...
elect <- data.frame(rbind(c(0.2238, 0.0719, 0.0765, 0.0407, 0.4525, 0.0616, 0.0502, 0.0025, 0),
...
elec_date <- c(as.Date('1994-09-18'), as.Date('1998-09-20'), as.Date('2002-09-15'), as.Date('2006-09-17'),as.Date('2010-09-19'),as.Date('2014-09-14'), as.Date('2018-09-09'))
publ_year <- c("1994-sep", "1998-sep", "2002-sep", "2006-sep","2010-sep","2014-sep", "2018-sep")
eligible_votes <- c(5555540, 5261122, 5303212, 5551278, 6028682, 6290016, 6532063)
